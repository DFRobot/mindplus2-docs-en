...
Click the **"Add Category"** button to add the required categories for the image classification task. You can create multiple categories according to your project requirements for subsequent data collection and model training.
