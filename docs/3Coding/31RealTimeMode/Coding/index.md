...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [**Real-Time Mode (C1)**](../31RealTimeMode/index.md)                 | Uses block programming to control the stage without an external hardware board. The program runs in real time, and changes to blocks take effect immediately, making it ideal for introductory logic learning, animations, and interactive projects.                           |
